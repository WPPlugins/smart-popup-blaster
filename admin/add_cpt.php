...
function trigger_box($object){
    ...
    <table>
      ...
      <tr>
      <td colspan="5"><span id="click-help" style="background-color:#F1F1F1;padding:6px;<?php if ($popup_trigger !== 'none'){echo 'display:none;';} ?>"><small>For details how to use click trigger check help page.</small></span></td>
      </tr> 
      <td>Exit Intent: </td>
      ...
      <tr>
      <td colspan="5"><span id="exit_intent-help" style="background-color:#F1F1F1;padding:6px;<?php if ($popup_trigger !== 'exit_intent'){echo 'display:none;';} ?>"><small>When mouse leaving upper browser window, popup will be triggered. <strong>This trigger is available 4 seconds after page load.</strong></small></span></td>
      </tr> 
      <tr>
        <td>Delay: </td>
    ...
    <p id="scroll-help" style="background-color:#F1F1F1;padding:6px;<?php if ($popup_trigger !== 'scroll'){echo 'display:none;';} ?>"><small><strong>Lower percentage:</strong> bottom of the page </br><strong>Higher percentage:</strong> top of the page</small></p>
